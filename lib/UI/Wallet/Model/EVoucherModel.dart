...
List<EVoucherModel> eVoucherModelFromJson(String str) =>
    List<EVoucherModel>.from(json.decode(str).map((x) => EVoucherModel.fromJson(x)));
String EVoucherModelToJson(List<EVoucherModel> data) =>
