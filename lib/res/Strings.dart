...
const alert1="Alert";
const alert="Alert";
const contactEmail="acma@poket.om";
...
const choose_date = "Please select date of birth";
const enter_valid_mob = "Please enter valid mobile number";
const enter_empty_mob = "Please enter mobile number";
const choose_addr = "Please enter address";
const email_subject = "Recommending my favourite rewards app";
const email_body = "You gotta check out this awesome rewards app - Poket Rewards app. SO COOL! Get yours for FREE at https://poket.com/app";
